...
public class ProductSetExample implements IExample<ProductSet> {
    ...
    protected PageView<ProductSet> pageView;

    public ProductSetExample() {
    ...
    @Override
    public PageView<ProductSet> getPageView() {
        return pageView;
    }

    @Override
    public void setPageView(PageView<ProductSet> pageView) {
