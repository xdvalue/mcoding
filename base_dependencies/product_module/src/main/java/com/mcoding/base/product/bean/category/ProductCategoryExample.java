...
public class ProductCategoryExample implements IExample<ProductCategory> {
    ...
    protected PageView<ProductCategory> pageView;
    ...
    @Override
    public PageView<ProductCategory> getPageView() {
        return pageView;
    }

    @Override
    public void setPageView(PageView<ProductCategory> pageView) {
