...
public class ProductImgExample implements IExample<ProductImg> {
    ...
    protected PageView<ProductImg> pageView;
    ...
    @Override
    public PageView<ProductImg> getPageView() {
        return pageView;
    }

    @Override
    public void setPageView(PageView<ProductImg> pageView) {
