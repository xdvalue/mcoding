...
public class ProductSceneExample implements IExample<ProductScene> {
    ...
    protected PageView<ProductScene> pageView;

    public ProductSceneExample() {
    ...
    @Override
    public PageView<ProductScene> getPageView() {
        return pageView;
    }

    @Override
    public void setPageView(PageView<ProductScene> pageView) {
