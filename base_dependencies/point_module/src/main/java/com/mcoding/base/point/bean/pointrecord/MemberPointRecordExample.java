...
public class MemberPointRecordExample implements IExample<MemberPointRecord> {
    ...
    protected PageView<MemberPointRecord> pageView;

    public MemberPointRecordExample() {
    ...
    @Override
    public PageView<MemberPointRecord> getPageView() {
        return pageView;
    }

    @Override
    public void setPageView(PageView<MemberPointRecord> pageView) {
