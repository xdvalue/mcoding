...
var DataTableList = function () {
    ...
    var initTableHeaderInfo = function(){
        var aoColumns = [
			{ "sTitle": "订单商品关联ID", "mData": "id"},
			{ "sTitle": "订单id", "mData": "orderId"},
			{ "sTitle": "商品id", "mData": "productId"},
			{ "sTitle": "商品名称", "mData": "productName"},
			{ "sTitle": "商品单价或加钱购金额", "mData": "productPrice"},
			{ "sTitle": "单个商品数量", "mData": "nums"},
			{ "sTitle": "加钱购积分", "mData": "plusPoint"},
        ...
        aoColumns.push({
        	...
        	"sVisible" : false, 
        	"fnCreatedCell": function(nTd,sData, oData, iRow, iCol){
        	    var btnUpdateByIdHtml = "<span style='margin: 0 5px 0 5px'><span class='btn btn-xs purple ajaxify' href='orderProduct/service/toUpdateViewById?id="+oData.id+"'><i class='fa fa-edit'></i> 更改 </span>";
    ...
    var loadTableData = function(){
        ...
        oTable = $('#'+tableId).DataTable({
            ...
            "sAjaxSource": "orderProduct/service/findByPage",
...
//            "aoSearchCols": [null, null, {"sSearch":"myfilter"}, null, null, null, null, null, null],
    ...
    var deleteHandler = function(id){
    	bootbox.confirm("确认删除吗?", function(result) {
			...
			var url = 'orderProduct/service/deleteById?id=' +id;
