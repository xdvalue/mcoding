...
public class ShoppingCartExample implements IExample<ShoppingCart> {
    ...
    protected PageView<ShoppingCart> pageView;
    ...
    @Override
    public PageView<ShoppingCart> getPageView() {
        return pageView;
    }

    @Override
    public void setPageView(PageView<ShoppingCart> pageView) {
