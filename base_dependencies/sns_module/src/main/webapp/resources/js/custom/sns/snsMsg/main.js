...
var DataTableList = function () {
    ...
    var initTableHeaderInfo = function(){
        var aoColumns = [
			...
			},
			{
				...
				"fnCreatedCell":function(nTd,sData, oData, iRow, iCol){
					if(oData.enableTime){
						$(nTd).append(moment(oData.enableTime).format('YYYY-MM-DD HH:mm'));
					}
				}
			},
        ...
        aoColumns.push({
        	...
        	"fnCreatedCell": function(nTd,sData, oData, iRow, iCol){
        	    ...
        	    var btnUpdateByIdHtml = "<span style='margin: 0 5px 0 5px'><span class='btn btn-xs purple ajaxify' href='snsMsg/service/toUpdateViewById?id="+oData.id+"'><i class='fa fa-edit'></i> 更改 </span>";
    ...
    var loadTableData = function(){
        ...
        oTable = $('#'+tableId).DataTable({
            ...
            "sAjaxSource": "snsMsg/service/findByPage",
...
//            "aoSearchCols": [null, null, {"sSearch":"myfilter"}, null, null, null, null, null, null],
    ...
    var disableHandler = function(snsMsgId, isEnable){
    	...
    	bootbox.confirm(msg, function(result) {
			...
			var url = 'snsMsg/service/setIsEnableById?id=' +snsMsgId+'&isEnable=' + isEnable;
    ...
    var deleteHandler = function(id){
    	bootbox.confirm("确认删除吗?", function(result) {
			...
			var url = 'snsMsg/service/deleteById?id=' +id;
