...
function changeImg(){
    if(i<9){
        ...
        uploadCtrl= false;
        $("#showImg"+i).parent("li").append('<div id="loading" class="bui_bgc_white_d48" style="opacity: 0.7;position: absolute;top: 0;left: 0;height: 100%;width: 100%"><i class="fa fa-circle-o-notch fa-spin bui_ts_24_i bui_fac_white bui_p_12" style="position: absolute;left: 50%; margin-left: -25px;top: 30px"></i></div>');
        $.ajaxFileUpload({
