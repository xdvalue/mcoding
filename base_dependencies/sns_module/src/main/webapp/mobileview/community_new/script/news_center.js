...
function reCall(parentMemberName,commentId,parentMemberId,snsPostId){
	...
	if (parentMemberName != '') {
		buijs_modal({
			title: _modalTitle,
			positions: 'bottom',
			content: '<textarea maxlength="140" rows="6" placeholder="' + _modalTitle + '" class="bui_ipt_48 bui_block bui_bgc_white bui_ts_16" id="articleCommentTextarea"></textarea><div class=""><ul class="bui_avg_3 imgWrap"></ul></div>',
