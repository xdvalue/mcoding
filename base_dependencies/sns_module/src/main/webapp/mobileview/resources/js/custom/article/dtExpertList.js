...
var DTExpertList = function () {
    ...
    var initTableHeaderInfo = function(){
        var aoColumns = [
            ...
            { "sTitle": "专家名称", "mData": "name"},
            {
            	...
            	"fnCreatedCell" : function(nTd, sData, oData, iRow, iCol) {
            		$(nTd).append("<img src='" + oData.headimg + "' width='20%'>");
            	}
            },
			{ "sTitle": "所属公司", "mData": "company"},
			{ "sTitle": "职称", "mData": "title"},
			{
            	"sTitle": "微信二维码",
            	"mDataProp" : "",
            	"sDefaultContent" : "",
            	"sVisible" : false,
            	"fnCreatedCell" : function(nTd, sData, oData, iRow, iCol) {
            		$(nTd).append("<img src='" + oData.qrcode + "' width='40%'>");
            	}
            }
        ];
        //渲染特殊的列(操作列)
        var aoColumnDefs =[];
            aoColumns.push({
            	...
            	"sVisible" : false, 
            	"fnCreatedCell": function(nTd,sData, oData, iRow, iCol){
            		$(nTd).append("<span style='margin: 0 5px 0 5px'><span class='btn btn-xs purple ajaxify' href='page/addDTExpertPage.html?id="+oData.id+"'><i class='fa fa-edit'></i> 编辑 </span>");
    ...
    var loadTableData = function(){
        ...
        oTable = $('#'+tableId).DataTable({
            ...
            "sAjaxSource": "management/queryDTExpertByPage.html",
    ...
    var initToolBar = function(){
        ...
        $("#deleteBut").on("click", function(){
            ...
            $.ajax({
                type: "post",
                data: param,
                url: 'management/deleteDTExpertById.html',
