//员工通讯录
var running_runningResultList = function () {
	var tableId = "tableId";
	var oTable = null;
    ...
    var initTableHeaderInfo = function(){
        var aoColumns = [
			...
			{ "sTitle": "已跑次数","sWidth" : "1%", "mData": "sequence"},
			{
				"sTitle": "成绩",
				"mDataProp" : "",
				"sDefaultContent" : "",
            ...
            aoColumns.push({
            	...
            	"fnCreatedCell": function(nTd,sData, oData, iRow, iCol){
        			...
        			$(nTd).append("<span style='margin: 0 5px 0 5px'><span class='btn btn-xs purple ajaxify'" +
        					" href='preResultPageView.html?openid="+oData.openid+"'><i class='fa fa-edit'></i> 各次跑步成绩 </span>");
        			$(nTd).append("<span style='margin: 0 5px 0 5px'><span class='btn btn-xs purple ajaxify'" +
        					" href='runningHelpPageView.html?openid="+oData.openid+"'><i class='fa fa-edit'></i> 助跑记录 </span>");
                }
            });
    ...
    var loadTableData = function(){
        ...
        oTable = $('#'+tableId).DataTable({
            "sAjaxSource": "queryRunningResultData.html",
