...
var mallgame_gamblingList = function () {
    ...
    var initTableHeaderInfo = function(){
        var aoColumns = [
			...
			{ "sTitle": "抽奖概率范围","sWidth" : "1%", "mData": "prizerange"},
			{ "sTitle": "抽奖随机数","sWidth" : "1%", "mData": "ext1"},
			{ "sTitle": "抽奖次数","sWidth" : "1%", "mData": "daydrawnum"}
        ];
        //渲染特殊的列(操作列)
        var aoColumnDefs =[];
            aoColumns.push({
            	...
            	"fnCreatedCell": function(nTd,sData, oData, iRow, iCol){
            		if(App.checkUserOperRight("gameList", "editGame")){
            			$(nTd).append("<span style='margin: 0 5px 0 5px'><span class='btn btn-xs purple ajaxify'" +
            					" href='addGamblingView.html?id="+oData.id+"'><i class='fa fa-edit'></i> 编辑 </span>");
            		}
    ...
    var loadTableData = function(){
        ...
        oTable = $('#'+tableId).DataTable({
            "sAjaxSource": "queryGamblingData.html",
