            ...
            aoColumns.push({
            	...
            	"fnCreatedCell": function(nTd,sData, oData, iRow, iCol){
            		if(App.checkUserOperRight("rightManager", "distributionRole")){
            			$(nTd).append("<span class='btn default btn-xs purple selectRole' data-target='#selectRole' data-toggle='modal' href='navigateSelectRole.html?configUserId="+oData.userId+"'><i class='fa fa-edit'></i> 分配角色</span>");
            		}
