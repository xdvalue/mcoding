...
public class SnsMsgExample implements IExample<SnsMsg> {
    ...
    protected PageView<SnsMsg> pageView;

    public SnsMsgExample() {
    ...
    @Override
    public PageView<SnsMsg> getPageView() {
        return pageView;
    }

    @Override
    public void setPageView(PageView<SnsMsg> pageView) {
