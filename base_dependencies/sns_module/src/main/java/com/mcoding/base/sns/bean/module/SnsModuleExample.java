...
public class SnsModuleExample implements IExample<SnsModule> {
    ...
    protected PageView<SnsModule> pageView;

    public SnsModuleExample() {
    ...
    @Override
    public PageView<SnsModule> getPageView() {
        return pageView;
    }

    @Override
    public void setPageView(PageView<SnsModule> pageView) {
