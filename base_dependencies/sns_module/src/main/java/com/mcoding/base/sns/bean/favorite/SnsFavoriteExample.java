package com.mcoding.base.sns.bean.favorite;
...
public class SnsFavoriteExample implements IExample<SnsFavorite> {
	...
	protected PageView<SnsFavorite> pageView;

	public SnsFavoriteExample() {
	...
	@Override
	public PageView<SnsFavorite> getPageView() {
		return pageView;
	}

	@Override
	public void setPageView(PageView<SnsFavorite> pageView) {
