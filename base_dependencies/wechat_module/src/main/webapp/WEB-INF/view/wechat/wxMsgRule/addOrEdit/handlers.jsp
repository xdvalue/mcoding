		...
		<div class="portlet box blue">
			...
			<div class="portlet-body form">
				<form action="#" id="wxMsgRuleForm" class="form-horizontal">
				    <input name="handlers" id="handlersHidden" type="hidden" value="${wxMsgRule.handlers}"/>
					<div class="form-body">
						<div class="form-group">
							<label class="col-md-3 control-label">回复的消息类型 </label>
							<div class="col-md-9">
								<mcoding:dicGroupSelectTag dicGroupCode="wx_msg_rule_reply_type"
									id="handlersSelect"
									selectedItemValue="${wxMsgRule.handlers}"
									onChange="changeHandlers(this);" />
							</div>
						</div>
					</div>
...
<script type="text/javascript">
	DataTableList.init();
	function changeHandlers(input){
		var select = $(input);
		$('#handlersHidden').val(select.val());
	}
</script>
