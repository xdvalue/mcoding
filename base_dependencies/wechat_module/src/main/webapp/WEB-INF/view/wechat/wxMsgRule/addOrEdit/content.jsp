		...
		<div class="portlet box blue">
			...
			<div class="portlet-body form">
				<form action="#" id="wxMsgRuleForm" class="form-horizontal">
				    <textarea id="contentTextArea" type="text" name="content" style="display:none;">${wxMsgRule.content}</textarea>
					...
					<div class="form-body">
						...
						<div class="form-group">
							<label class="col-md-3 control-label">匹配的内容<span
								class="required">*</span>
							</label>
							<div class="col-md-4">
								<div class="input-group">
									<input type="text" id="addContentInput" 
										class="form-control input-inline input-medium" placeholder="输入匹配的内容" /> 
