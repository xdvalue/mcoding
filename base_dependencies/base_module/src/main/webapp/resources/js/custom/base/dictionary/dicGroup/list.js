...
var DataTableList = function () {
    ...
    var initTableHeaderInfo = function(){
        ...
        aoColumns.push({
        	...
        	"fnCreatedCell": function(nTd,sData, oData, iRow, iCol){
        		...
        		$(nTd).append("<span style='margin: 0 5px 0 5px'><span class='btn btn-xs purple ajaxify' href='dicGroupItem/service/toListPageView?dicGroupId="+oData.id+"'><i class='fa fa-edit'></i> 查看字典值 </span>");
        		$(nTd).append("<span style='margin: 0 5px 0 5px'><span class='btn btn-xs purple ajaxify' href='dicGroup/service/toUpdateViewById?id="+oData.id+"'><i class='fa fa-edit'></i> 更改 </span>");
    ...
    var loadTableData = function(){
        ...
        oTable = $('#'+tableId).DataTable({
            ...
            "sAjaxSource": "dicGroup/service/findByPage",
...
//            "aoSearchCols": [null, null, {"sSearch":"myfilter"}, null, null, null, null, null, null],
    ...
    var initToolBar = function(){
        ...
        $("#confirmWin").on("show.bs.modal", function(e){
            ...
            $("#dicGroupId").val('').val(dicGroupId);
        });
        
        $("#deleteBut").on("click", function(){
            var url = 'dicGroup/service/deleteById';
