...
public class DepartmentAddressExample implements IExample<DepartmentAddress> {
    ...
    protected PageView<DepartmentAddress> pageView;

    public DepartmentAddressExample() {
    ...
    @Override
    public PageView<DepartmentAddress> getPageView() {
        return pageView;
    }

    @Override
    public void setPageView(PageView<DepartmentAddress> pageView) {
