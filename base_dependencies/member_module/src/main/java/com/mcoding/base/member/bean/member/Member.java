...
public class Member implements Serializable {
	...
	@ApiModelProperty(name = "会员拓展信息")
	private Map<String, IMemberExtInfo> memberExtInfoMap;
	...
	public Map<String, IMemberExtInfo> getMemberExtInfoMap() {
		return memberExtInfoMap;
	}
	
	public void setMemberExtInfoMap(Map<String, IMemberExtInfo> memberExtInfoMap) {
		this.memberExtInfoMap = memberExtInfoMap;
	}
