...
public class MemberAddressExample implements IExample<MemberAddress> {
    ...
    protected PageView<MemberAddress> pageView;
    ...
    @Override
    public PageView<MemberAddress> getPageView() {
        return pageView;
    }

    @Override
    public void setPageView(PageView<MemberAddress> pageView) {
