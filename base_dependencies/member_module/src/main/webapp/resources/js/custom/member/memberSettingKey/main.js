...
var DataTableList = function () {
    ...
    var initTableHeaderInfo = function(){
        var aoColumns = [
			{ "sTitle": "id", "mData": "id"},
			{ "sTitle": "模块类型，100 sns模块，200会员模块", "mData": "moduleType"},
			{ "sTitle": "配置名称", "mData": "settingName"},
			{ "sTitle": "配置代码", "mData": "settingCode"},
			{ "sTitle": "配置默认值", "mData": "settingDefaultValue"},
        ...
        aoColumns.push({
        	...
        	"sVisible" : false, 
        	"fnCreatedCell": function(nTd,sData, oData, iRow, iCol){
        	    var btnUpdateByIdHtml = "<span style='margin: 0 5px 0 5px'><span class='btn btn-xs purple ajaxify' href='memberSettingKey/service/toUpdateViewById?id="+oData.id+"'><i class='fa fa-edit'></i> 更改 </span>";
    ...
    var loadTableData = function(){
        ...
        oTable = $('#'+tableId).DataTable({
            ...
            "sAjaxSource": "memberSettingKey/service/findByPage",
...
//            "aoSearchCols": [null, null, {"sSearch":"myfilter"}, null, null, null, null, null, null],
    ...
    var deleteHandler = function(id){
    	bootbox.confirm("确认删除吗?", function(result) {
			...
			var url = 'memberSettingKey/service/deleteById?id=' +id;
