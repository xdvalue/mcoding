...
var DataTableList = function () {
	...
	var parentId = $('#divParentId').attr('parentId');
	
	//初始化加载表格数据的表头定义
    var initTableHeaderInfo = function(){
        var aoColumns = [
			{ "sTitle": "所属公司名称", "mData": "companyName"},
			{ "sTitle": "部门名称", "mData": "departmentName"},
    ...
    var loadTableData = function(){
        ...
        var url = "memberDepartment/service/findByPage?parentId=" + parentId;
