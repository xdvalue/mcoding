...
var DataTableList = function () {
    ...
    var initTableHeaderInfo = function(){
        var aoColumns = [
			{ "sTitle": "地址id", "mData": "id"},
			{ "sTitle": "公司id", "mData": "companyId"},
			{ "sTitle": "收货人姓名", "mData": "receiver"},
			{ "sTitle": "手机号码", "mData": "phone"},
			{ "sTitle": "省市县地区 空格隔开", "mData": "regson"},
			{ "sTitle": "详细地址", "mData": "address"},
			{ "sTitle": "是否默认地址，0不是，1是", "mData": "isDefault"},
        ...
        aoColumns.push({
        	...
        	"sVisible" : false, 
        	"fnCreatedCell": function(nTd,sData, oData, iRow, iCol){
        	    var btnUpdateByIdHtml = "<span style='margin: 0 5px 0 5px'><span class='btn btn-xs purple ajaxify' href='departmentAddress/service/toUpdateViewById?id="+oData.id+"'><i class='fa fa-edit'></i> 更改 </span>";
    ...
    var loadTableData = function(){
        ...
        oTable = $('#'+tableId).DataTable({
            ...
            "sAjaxSource": "departmentAddress/service/findByPage",
...
//            "aoSearchCols": [null, null, {"sSearch":"myfilter"}, null, null, null, null, null, null],
    ...
    var deleteHandler = function(id){
    	bootbox.confirm("确认删除吗?", function(result) {
			...
			var url = 'departmentAddress/service/deleteById?id=' +id;
