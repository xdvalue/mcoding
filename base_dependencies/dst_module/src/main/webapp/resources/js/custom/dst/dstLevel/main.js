...
var DataTableList = function () {
    ...
    var initTableHeaderInfo = function(){
        var aoColumns = [
			{ "sTitle": "主键", "mData": "id"},
			{ "sTitle": "分销商级别名称", "mData": "levelName"},
			{ "sTitle": "分销商级别", "mData": "levelGrade"},
			{ "sTitle": "上级级别id", "mData": "parentLevelId"},
        ...
        aoColumns.push({
        	...
        	"sVisible" : false, 
        	"fnCreatedCell": function(nTd,sData, oData, iRow, iCol){
        	    var btnUpdateByIdHtml = "<span style='margin: 0 5px 0 5px'><span class='btn btn-xs purple ajaxify' href='dstLevel/service/toUpdateViewById?id="+oData.id+"'><i class='fa fa-edit'></i> 更改 </span>";
    ...
    var loadTableData = function(){
        ...
        oTable = $('#'+tableId).DataTable({
            ...
            "sAjaxSource": "dstLevel/service/findByPage",
...
//            "aoSearchCols": [null, null, {"sSearch":"myfilter"}, null, null, null, null, null, null],
    ...
    var deleteHandler = function(id){
    	bootbox.confirm("确认删除吗?", function(result) {
			...
			var url = 'dstLevel/service/deleteById?id=' +id;
