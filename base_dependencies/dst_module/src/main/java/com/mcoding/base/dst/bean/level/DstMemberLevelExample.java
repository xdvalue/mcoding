...
public class DstMemberLevelExample implements IExample<DstMemberLevel> {
    ...
    protected PageView<DstMemberLevel> pageView;

    public DstMemberLevelExample() {
    ...
    @Override
    public PageView<DstMemberLevel> getPageView() {
        return pageView;
    }

    @Override
    public void setPageView(PageView<DstMemberLevel> pageView) {
