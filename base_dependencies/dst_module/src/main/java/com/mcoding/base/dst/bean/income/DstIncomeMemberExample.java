...
public class DstIncomeMemberExample implements IExample<DstIncomeMember> {
    ...
    protected PageView<DstIncomeMember> pageView;

    public DstIncomeMemberExample() {
    ...
    @Override
    public PageView<DstIncomeMember> getPageView() {
        return pageView;
    }

    @Override
    public void setPageView(PageView<DstIncomeMember> pageView) {
