...
public class DstIncomeProductExample implements IExample<DstIncomeProduct> {
    ...
    protected PageView<DstIncomeProduct> pageView;

    public DstIncomeProductExample() {
    ...
    @Override
    public PageView<DstIncomeProduct> getPageView() {
        return pageView;
    }

    @Override
    public void setPageView(PageView<DstIncomeProduct> pageView) {
