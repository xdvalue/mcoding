...
public class MemberExtInfoExample implements IExample<MemberExtInfo> {
    ...
    protected PageView<MemberExtInfo> pageView;

    public MemberExtInfoExample() {
    ...
    @Override
    public PageView<MemberExtInfo> getPageView() {
        return pageView;
    }

    @Override
    public void setPageView(PageView<MemberExtInfo> pageView) {
