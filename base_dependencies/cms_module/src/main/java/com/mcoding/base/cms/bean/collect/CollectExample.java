 ...
 * 
 */
public class CollectExample implements IExample<Collect> {
	...
	protected PageView<Collect> pageView;
	...
	@Override
	public PageView<Collect> getPageView() {
		return pageView;
	}

	@Override
	public void setPageView(PageView<Collect> pageView) {
