 ...
 * 
 */
public class FavoriteExample implements IExample<Favorite> {
	...
	protected PageView<Favorite> pageView;
	...
	@Override
	public PageView<Favorite> getPageView() {
		return pageView;
	}

	@Override
	public void setPageView(PageView<Favorite> pageView) {
