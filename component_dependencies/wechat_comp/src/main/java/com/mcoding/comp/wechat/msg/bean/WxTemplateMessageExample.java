...
public class WxTemplateMessageExample implements IExample<WxTemplateMessage> {
    ...
    protected PageView<WxTemplateMessage> pageView;

    public WxTemplateMessageExample() {
